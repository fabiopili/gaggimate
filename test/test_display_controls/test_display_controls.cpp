...
//   B — FlowTrimmer slew-gate fade: trim authority must fade continuously
//       across the pressure-slew gate rather than toggle, because in the
//       shot tails the decay slew sits right on the gate and each toggle
//       moved the whole proportional term in and out of the command (the
//       audible duty sawtooth on shots 25/26)
//
